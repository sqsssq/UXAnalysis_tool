...
<template>
    ...
    <div style="height: calc(100vh - 40px); width: calc(100% - 0px);">
        <div class="framework" id="videoView" style="position: absolute; left: calc(10px); top: calc(5px); height: calc(75%); width: calc(70vw - 0px);">
            <MainView />
        </div>
        ...
        <div class="framework" id="recommendView" style="position: absolute; left: calc(10px); bottom: calc(5px); height: calc(25% - 20px); width: calc(70vw);">
            <RecommendList />
        </div>
    </div>
</template>
